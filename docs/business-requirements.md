...
* Invitation emails contain HTML and plain-text content, identify links as single-use with a 72-hour expiry, and must not contain passwords, roles, internal notes, or technical SMTP details.
