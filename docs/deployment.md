...
* Clients with personal selections above 100 bypass the five-minute guard. Raising a user's selection above 100 clears their in-memory counter; lowering it back to 100 or fewer restores the guard with a fresh counter. The request-rate limit, export quotas, hourly activity alerts and email delivery remain active for these clients.
