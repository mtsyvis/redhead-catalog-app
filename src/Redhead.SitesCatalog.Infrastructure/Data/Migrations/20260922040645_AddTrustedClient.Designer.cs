...
namespace Redhead.SitesCatalog.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260922040645_AddTrustedClient")]
    partial class AddTrustedClient
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.AhrefsSyncRun", b =>
                {
                    ...
                    b.Property<long>("ActualUnits")
                        .HasColumnType("bigint");

                    b.Property<long?>("AvailableUnitsAfter")
                        .HasColumnType("bigint");

                    b.Property<long>("AvailableUnitsBefore")
                        .HasColumnType("bigint");

                    b.Property<int>("BatchSize")
                        .HasColumnType("integer");

                    b.Property<int>("CostPerSite")
                        .HasColumnType("integer");

                    b.Property<int>("EligibleSitesCount")
                        .HasColumnType("integer");

                    b.Property<string>("ErrorMessage")
                        .HasColumnType("text");

                    b.Property<int>("FailedSitesCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<long>("FullEstimatedUnits")
                        .HasColumnType("bigint");

                    b.Property<bool>("IsFullCoverage")
                        .HasColumnType("boolean");

                    b.Property<int>("MaxSitesPerRun")
                        .HasColumnType("integer");

                    b.Property<int>("ProcessedSitesCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SafetyBufferUnits")
                        .HasColumnType("integer");

                    b.Property<long>("SelectedEstimatedUnits")
                        .HasColumnType("bigint");

                    b.Property<int>("SelectedSitesCount")
                        .HasColumnType("integer");

                    b.Property<int>("SkippedSitesCount")
                        .HasColumnType("integer");

                    b.Property<DateOnly>("SnapshotMonth")
                        .HasColumnType("date");
                    ...
                    b.Property<int>("StopIfRemainingUnitsBelow")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("UpdatedSitesCount")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("UsageResetDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("VolumeMode")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");

                    b.Property<bool>("WasLimitedByBudget")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("SnapshotMonth", "Status", "IsFullCoverage");

                    b.ToTable("AhrefsSyncRuns", null, t =>
                        {
                            t.HasCheckConstraint("CK_AhrefsSyncRuns_RunKind_ValidValue", "\"RunKind\" IN (1, 2, 3, 4)");

                            t.HasCheckConstraint("CK_AhrefsSyncRuns_Status_ValidValue", "\"Status\" IN (1, 2, 3, 4, 5, 6, 7, 8)");
                        });
                });

            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.AhrefsSyncRunItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int?>("AhrefsIndex")
                        .HasColumnType("integer");
                    ...
                    b.Property<double?>("NewDomainRating")
                        .HasColumnType("double precision");

                    b.Property<long?>("NewTraffic")
                        .HasColumnType("bigint");

                    b.Property<double>("OldDomainRating")
                        .HasColumnType("double precision");

                    b.Property<long>("OldTraffic")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AhrefsSyncRunItems", null, t =>
                        {
                            t.HasCheckConstraint("CK_AhrefsSyncRunItems_Status_ValidValue", "\"Status\" IN (1, 2, 3, 4)");
                        });
                });
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("ClientCatalogAutoBanResetAtUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("IsTrustedClient")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("AspNetUsers", null, t =>
                        {
                            t.HasCheckConstraint("CK_AspNetUsers_ClientSelectionLimitOverride_ValidRange", "\"ClientSelectionLimitOverride\" IS NULL OR (\"ClientSelectionLimitOverride\" BETWEEN 1 AND 100)");
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.ClientCatalogAutoBan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("ClientCatalogAutoBans");
                });

            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.ClientCatalogProtectionSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AutoBanEnabled")
                        .HasColumnType("boolean");

                    b.Property<int>("AutoBanUniqueSitesPer24Hours")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ClientCatalogProtectionSettings", null, t =>
                        {
                            t.HasCheckConstraint("CK_ClientCatalogProtectionSettings_AutoBanThreshold_Positive", "\"AutoBanUniqueSitesPer24Hours\" > 0");

                            t.HasCheckConstraint("CK_ClientCatalogProtectionSettings_Singleton", "\"Id\" = 1");
                        });
                });
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.LiteMultiSearchUsage", b =>
                {
                    ...
                    b.Property<int>("DomainsUsed")
                        .HasColumnType("integer");

                    b.Property<DateTime>("UpdatedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.HasKey("UserId", "MonthStartUtc");

                    b.ToTable("LiteMultiSearchUsages", null, t =>
                        {
                            t.HasCheckConstraint("CK_LiteMultiSearchUsages_DomainsUsed_NonNegative", "\"DomainsUsed\" >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.MissingDomainSearch", b =>
                {
                    ...
                    b.HasKey("SearchId", "Domain");

                    b.HasIndex("Domain");

                    b.ToTable("MissingDomainSearches");
                });

            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.MultiSearchAnalyticsRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SearchedAtUtc", "Role");

                    b.HasIndex("UserId", "RequestId")
                        .IsUnique();

                    b.ToTable("MultiSearchAnalyticsRequests");
                });
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.Site", b =>
                {
                    ...
                    b.Property<DateTime?>("AhrefsLastSyncedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.SiteMetricSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid?>("AhrefsSyncRunId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("DomainRating")
                        .HasColumnType("double precision");
                    ...
                    b.HasIndex("AhrefsSyncRunId");

                    b.HasIndex("Domain", "SnapshotDate")
                        .IsUnique();

                    b.ToTable("SiteMetricSnapshots", (string)null);
                });
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.AhrefsSyncRunItem", b =>
                {
                    b.HasOne("Redhead.SitesCatalog.Domain.Entities.AhrefsSyncRun", "Run")
                        .WithMany("Items")
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.MissingDomainSearch", b =>
                {
                    b.HasOne("Redhead.SitesCatalog.Domain.Entities.MultiSearchAnalyticsRequest", "Search")
                        .WithMany("MissingDomains")
            ...
            modelBuilder.Entity("Redhead.SitesCatalog.Domain.Entities.SiteMetricSnapshot", b =>
                {
                    b.HasOne("Redhead.SitesCatalog.Domain.Entities.AhrefsSyncRun", "AhrefsSyncRun")
                        .WithMany("Snapshots")
                        .HasForeignKey("AhrefsSyncRunId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("AhrefsSyncRun");
                });
