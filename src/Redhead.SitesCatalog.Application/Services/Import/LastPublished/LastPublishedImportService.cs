...
namespace Redhead.SitesCatalog.Application.Services.Import.LastPublished;
        ...
        CancellationToken cancellationToken = default)
    {
                         ...
                         ct: cancellationToken))
        {
                               ...
                               cancellationToken))
            {
                ...
                {
                    invalidRowsCount++;
                    ImportRowTrackingHelper.AddInvalidRow(invalidRowsPayload, rowNumber, rawValues, "LastPublishedDate is required and cannot be empty.");
                    continue;
                }
                ...
                {
                    invalidRowsCount++;
                    ImportRowTrackingHelper.AddInvalidRow(invalidRowsPayload, rowNumber, rawValues, parseError);
                    continue;
                }
        ...
        foreach (var chunk in ImportBatchingHelper.Chunk(domainsForUpdate, BatchSize))
        {
